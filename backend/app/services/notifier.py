...
async def send_bill_alerts(bill_id: str, force: bool = False) -> Dict[str, Any]:
    ...
    for sub in subscribers:
        ...
        if lang.lower() in ("sw", "swahili"):
            msg = f"Taarifa ya KeLegislate: Mswada mpya '{bill_title}' unaweza kuathiri biashara yako. Pata maelezo na ushiriki wa umma kwa https://kelegislate.co.ke/bills/{bill_id}"
        else:
            msg = f"KeLegislate Alert: New bill '{bill_title}' may impact your business. View details and public participation info at https://kelegislate.co.ke/bills/{bill_id}"
