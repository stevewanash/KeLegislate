...
async def send_bill_alerts(bill_id: str, force: bool = False) -> Dict[str, Any]:
    ...
    for sub in subscribers:
        ...
        if lang.lower() in ("sw", "swahili"):
            msg = f"Taarifa ya Hustleyetu: Mswada mpya '{bill_title}' unaweza kuathiri biashara yako. Pata maelezo na ushiriki wa umma kwa https://hustleyetu.co.ke/bills/{bill_id}"
        else:
            msg = f"Hustleyetu Alert: New bill '{bill_title}' may impact your business. View details and public participation info at https://hustleyetu.co.ke/bills/{bill_id}"
